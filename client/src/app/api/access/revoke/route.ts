/**
 * API Route: Revoke Access
 * Revoke access from a user for a private document
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    tx.moveCall({
      target: `${ACCESS_CONTROL_PACKAGE_ID}::access_control::revoke_access`,
      arguments: [
        tx.object(policyId),
    ...
    return NextResponse.json({
      ...
      message: 'Revoke access transaction prepared. Please sign with your wallet.',
    });
